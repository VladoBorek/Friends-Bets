...
<details id="wagers">
  <summary><strong>Wagers</strong></summary>

  [Previous: Dashboard](#dashboard) | [Next: Friends](#friends)

  <a href="./docs/screenshots/all_wagers.png">
    <img src="./docs/screenshots/all_wagers.png" alt="All wagers page" width="100%">
  </a>
  ...
  <a href="./docs/screenshots/wager_detail_2.png">
    <img src="./docs/screenshots/wager_detail_2.png" alt="Second wager detail page" width="100%">
  </a>
</details>
...
<details id="friends">
  ...
  [Previous: Wagers](#wagers) | [Next: Groups](#groups)
...
<details id="groups">
  ...
  [Previous: Friends](#friends) | [Next: Wallet](#wallet)
...
<details id="wallet">
  ...
  [Previous: Groups](#groups) | [Next: Admin](#admin)
...
<details id="admin">
  ...
  [Previous: Wallet](#wallet) | [Next: User Settings](#user-settings)
...
<details id="user-settings">
  <summary><strong>User Settings</strong></summary>

  [Previous: Admin](#admin) | [Next: Login](#login)
...
<details id="login">
  ...
  [Previous: User Settings](#user-settings)
